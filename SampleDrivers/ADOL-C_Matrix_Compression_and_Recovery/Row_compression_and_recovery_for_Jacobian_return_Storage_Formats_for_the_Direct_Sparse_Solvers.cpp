...
int main()
{
	...
	*ip1_ColorCount = *ip1_SeedRowCount;
	...
	JacobianRecovery1D::RecoverForPD2RowWise_SparseSolversFormat(g, *dp3_CompressedMatrix, *uip3_SparsityPattern, ip2_RowIndex, ip2_ColumnIndex, dp2_JacobianValue);
