...
int main()
{
	...
	g->BuildBPGraph_ADOLC(uip2_JacobianSparsityPattern, i_RowCount, i_ColumnCount);
	...
	*dp3_seed = g->GetSeedMatrix(ip1_SeedRowCount, ip1_SeedColumnCount);
	...
	In stead of doing step 1-3, you can just call the bellow function:
		g->GenerateSeedJacobian(uip2_JacobianSparsityPattern, i_RowCount,i_ColumnCount, dp3_seed, ip1_SeedRowCount, ip1_SeedColumnCount, "RIGHT_PARTIAL_DISTANCE_TWO", "SMALLEST_LAST"); // compress columns. This function is inside BipartiteGraphPartialColoringInterface class
	*/
