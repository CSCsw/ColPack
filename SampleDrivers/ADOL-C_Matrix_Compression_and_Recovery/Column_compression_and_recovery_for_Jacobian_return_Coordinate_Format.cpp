...
int main()
{
	...
	*ip1_ColorCount = *ip1_SeedColumnCount;
	...
	JacobianRecovery1D::RecoverForPD2ColumnWise_CoordinateFormat(g, *dp3_CompressedMatrix, *uip3_SparsityPattern, ip2_RowIndex, ip2_ColumnIndex, dp2_JacobianValue);
